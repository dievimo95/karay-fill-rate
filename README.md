...
El lector Odoo también reconoce pedidos y facturas bilingües con encabezados en inglés, unidades `Units` y decimales con punto. La revisión muestra el parser utilizado, la cantidad de productos y el motivo cuando un PDF no se reconoce.
